...
# Get the current working directory (where the .py is running)
...
def rename_columns(df, column_mapping, reverse=False):
    ...
    '''
    if reverse:
        # Reverse the mapping for normalized -> display-friendly
...
def main():
    ...
    email_body = f'''
        ...
        <p>Enrico Petrucci</p>
    '''
    send_email(EMAIL_FROM, email_to, subject, email_body, preview=True)
